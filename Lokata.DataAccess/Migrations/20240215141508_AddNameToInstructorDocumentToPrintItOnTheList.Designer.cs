...
namespace Lokata.DataAccess.Migrations
{
    ...
    [Migration("20240215141508_AddNameToInstructorDocumentToPrintItOnTheList")]
    partial class AddNameToInstructorDocumentToPrintItOnTheList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lokata.Domain.InstructorDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lokata.Domain.InstructorDocument", b =>
                {
                    b.HasOne("Lokata.Domain.Document", "Document")
                        .WithMany()
